...
from ultralytics_custom.yolo.utils import LOGGER, checks, clean_url, emojis, is_online, url2file
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from ultralytics_custom.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    from ultralytics_custom.yolo.utils import SETTINGS  # scoped for circular import
