...
from ultralytics_custom.yolo.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, clean_url, colorstr, emojis,
                                    yaml_load)
from ultralytics_custom.yolo.utils.checks import check_file, check_font, is_ascii
from ultralytics_custom.yolo.utils.downloads import download, safe_download, unzip_file
from ultralytics_custom.yolo.utils.ops import segments2boxes
...
class HUBDatasetStats():
    ...
    def get_json(self, save=False, verbose=False):
        ...
        from ultralytics_custom.yolo.data.dataloaders.v5loader import LoadImagesAndLabels
